...
const SupportPage = () => {
  ...
  return (
    ...
    >
      <ScrollView
        contentContainerStyle={{ ...styles.container, flexGrow: 1, paddingBottom: 100 }} // Added flexGrow and paddingBottom
        keyboardShouldPersistTaps="handled" // Ensures taps outside the input close the keyboard
        keyboardDismissMode="on-drag" // Dismisses keyboard on drag gestures
      >
        {/* Icon */}
